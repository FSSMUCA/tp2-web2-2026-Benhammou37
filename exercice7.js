...
console.log("Total à payer :", total.toFixed(3), "MAD");
...
if (paiementAccepte) {
  soldeCompte -= total;
  console.log("Nouveau solde :", soldeCompte.toFixed(3), "MAD");
}
...
console.log("Solde     :", paiementAccepte ? soldeCompte.toFixed(3) + " MAD" : soldeCompte.toFixed(2) + " MAD");
console.log("=========================");